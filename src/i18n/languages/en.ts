...
export const en: Translation = {
	...
	[Key.aiSummaryGenerating]: "Generating summary…",
	[Key.aiSummaryFailed]: "Failed to generate summary, click to retry",
	[Key.aiSummaryDisclaimer]: "Generated by AI, for reference only",
